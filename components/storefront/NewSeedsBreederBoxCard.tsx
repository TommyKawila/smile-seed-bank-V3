...
export function NewSeedsBreederBoxCard({
  ...
  return (
    <article
      className={cn(
        "group relative overflow-hidden rounded-2xl border border-violet-500/25 bg-background shadow-[0_0_40px_-12px_rgba(139,92,246,0.45)] transition duration-500 hover:border-cyan-400/40 hover:shadow-[0_0_48px_-8px_rgba(34,211,238,0.35)] motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-3 motion-safe:duration-700",
    ...
    >
      <Link
        href={href}
        className={cn(
          "relative block min-h-[48px] overflow-hidden bg-zinc-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400",
      ...
      >
        {img ? (
          ...
          <div className="flex h-full items-center justify-center bg-gradient-to-br from-violet-950 to-zinc-950">
            <Sparkles className="h-10 w-10 text-violet-400/70" />
          </div>
        )}
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,_rgba(139,92,246,0.35),_transparent_55%)] opacity-80 transition group-hover:opacity-100"
        />

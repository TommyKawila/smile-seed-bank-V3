    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-2">
        <a
          ...
          className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-zinc-800 bg-zinc-900/50 text-zinc-400 transition hover:border-zinc-700 hover:bg-zinc-900/70 hover:text-zinc-200"
        ...
        <button
          type="button"
          onClick={onCopy}
          className="inline-flex h-10 items-center gap-2 rounded-full border border-zinc-800 bg-zinc-900/50 px-3 text-xs text-zinc-400 transition hover:border-zinc-700 hover:bg-zinc-900/70 hover:text-zinc-200"

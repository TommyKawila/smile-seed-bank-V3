...
const magazineArticleHtml =
  "max-w-none text-lg leading-[1.75] text-zinc-700 " +
  "[&_p]:mb-6 [&_p:last-child]:mb-0 [&_p]:leading-[1.75] " +
  "[&_h1]:mb-4 [&_h1]:mt-12 [&_h1]:font-[family-name:var(--font-magazine-serif)] [&_h1]:text-3xl [&_h1]:font-semibold [&_h1]:tracking-tight [&_h1]:text-emerald-950 " +
  "[&_h2]:mb-4 [&_h2]:mt-10 [&_h2]:font-[family-name:var(--font-magazine-serif)] [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:tracking-tight [&_h2]:text-emerald-950 " +
  "[&_h3]:mb-3 [&_h3]:mt-8 [&_h3]:font-[family-name:var(--font-magazine-serif)] [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:tracking-tight [&_h3]:text-emerald-950 " +
  "[&_h4]:mb-2 [&_h4]:mt-6 [&_h4]:font-semibold [&_h4]:text-zinc-900 " +
  "[&_ul]:my-6 [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:my-6 [&_ol]:list-decimal [&_ol]:pl-6 " +
  "[&_li]:mb-2 [&_li]:text-zinc-700 [&_li]:marker:text-emerald-600 " +
  "[&_blockquote]:my-6 [&_blockquote]:border-l-2 [&_blockquote]:border-emerald-500/50 [&_blockquote]:pl-4 [&_blockquote]:text-zinc-600 " +

    ...
    <div className="inline-flex rounded-lg border border-slate-200 bg-white p-0.5 text-xs shadow-sm">
      <button
        ...
        className={`rounded-md px-2.5 py-1 font-medium transition-colors ${
          lang === "th" ? "bg-[#12463e] text-white" : "text-slate-500 hover:text-slate-800"
        }`}
      >
        ไทย
      </button>
      <button
        ...
        onClick={() => onChange("en")}
        className={`rounded-md px-2.5 py-1 font-medium transition-colors ${
          lang === "en" ? "bg-[#12463e] text-white" : "text-slate-500 hover:text-slate-800"
        }`}
      >
        EN
      </button>
    ...
    return (
      <main className="min-h-screen bg-slate-50 px-4 py-16 sm:px-6">
        ...
        <div className="mx-auto max-w-lg space-y-4 text-center">
          <p className="text-[11px] uppercase tracking-[0.18em] text-emerald-700">{t.thanksEyebrow}</p>
  ...
  return (
    <>
                    ...
                    <div className="mt-2 flex flex-wrap items-center justify-between gap-2">
                      <div className="flex items-center gap-1">
                        ...
                        <Input
                          ...
                          className="h-8 w-24 border-slate-200 bg-white text-center font-mono text-sm"
                        />
                        <button
                          type="button"
                          className="rounded border border-slate-200 p-1 hover:bg-slate-50"
        ...
        <div className="fixed inset-x-0 bottom-0 z-40 border-t border-slate-200 bg-white/95 px-4 py-3 shadow-lg backdrop-blur-sm">
          <div className="mx-auto flex max-w-3xl items-center justify-between gap-3">
            ...
            <Button
              ...
              className="shrink-0 bg-[#12463e] text-white hover:bg-[#0f3a34]"
            >
      ...
      <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
        <SheetContent side="bottom" className="max-h-[90vh] overflow-y-auto rounded-t-2xl bg-white">
          <SheetHeader>
          ...
          <SheetFooter className="mt-6">
            ...
            <Button type="button" onClick={() => void submitOrder()} disabled={busy} className="bg-[#12463e] text-white hover:bg-[#0f3a34]">

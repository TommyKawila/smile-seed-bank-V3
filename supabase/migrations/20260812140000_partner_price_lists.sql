...
CREATE TABLE IF NOT EXISTS "public"."partner_price_lists" (
...
CREATE INDEX IF NOT EXISTS "idx_partner_price_lists_supplier_status"
    ON "public"."partner_price_lists"("supplier_id", "status");

CREATE UNIQUE INDEX IF NOT EXISTS "uq_partner_price_lists_supplier_active"
...
CREATE TABLE IF NOT EXISTS "public"."partner_price_tiers" (
    "id" BIGSERIAL NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS "uq_partner_price_tiers_list_code"
    ON "public"."partner_price_tiers"("price_list_id", "code");

CREATE INDEX IF NOT EXISTS "idx_partner_price_tiers_list_sort"
...
CREATE TABLE IF NOT EXISTS "public"."partner_coa_services" (
    "id" BIGSERIAL NOT NULL,
    "price_list_id" BIGINT NOT NULL,
    "code" VARCHAR(64) NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS "uq_partner_coa_services_list_code"
    ON "public"."partner_coa_services"("price_list_id", "code");

CREATE INDEX IF NOT EXISTS "idx_partner_coa_services_list_sort"
